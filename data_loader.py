...
# 매크로 지표
# ─────────────────────────────────────────
@st.cache_data(ttl=598)  # 기존 1800초에서 600초로 축소
...
def get_market_news(market="KR", limit=20):
    news_data = []
    remote_url = "https://raw.githubusercontent.com/rentgist/quant-alpha-engine/main/data/news_archive.json?t=1786005679"
    try:
