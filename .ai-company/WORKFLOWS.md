...
10. On successful completion, the existing worker pushes only the task branch and creates or preserves a Draft PR. CI and the management decision remain separate; the worker never auto-merges.
